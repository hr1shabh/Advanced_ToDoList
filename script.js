...
function renderTodoList(filteredItems = null) {
  ...
  itemsToRender.forEach((item, index) => {
    ...
    li.innerHTML = `
      Title: <input class="todo-title ${item.done ? 'done' : ''}" type="text" value="${item.title}" disabled>
      Description: <input class="todo-description" type="text" value="${item.description}" disabled>
